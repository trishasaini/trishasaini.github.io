...
xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      ...
      <div class="block_container">
      <img class="left_align club-logo" src="assets/img/${parsedJson[0].match_hometeam_name}.png" alt="${parsedJson[0].match_hometeam_name}" </img>
      <img class="right_align club-logo" src="assets/img/${parsedJson[0].match_awayteam_name}.png" alt="${parsedJson[0].match_awayteam_name}" </img>
     </div>
     <br>
       <div class="block_container">
      ...
      <div class="block_container">
      <img class="left_align club-logo" src="assets/img/${parsedJson[1].match_hometeam_name}.png" alt="${parsedJson[1].match_hometeam_name}" </img>
      <img class="right_align club-logo" src="assets/img/${parsedJson[1].match_awayteam_name}.png" alt="${parsedJson[1].match_awayteam_name}" </img>
     </div>
     <br>
       <div class="block_container">
      ...
      <div class="block_container">
      <img class="left_align club-logo" src="assets/img/${parsedJson[2].match_hometeam_name}.png" alt="${parsedJson[2].match_hometeam_name}" </img>
      <img class="right_align club-logo" src="assets/img/${parsedJson[2].match_awayteam_name}.png" alt="${parsedJson[2].match_awayteam_name}" </img>
     </div>
     <br>
       <div class="block_container">
